...
void Pointer::on_pushButton_clicked()
{
    ...
    else if(zaehler2 == 2)
    {
        ...
        ui->label_2->setText("<html><head/><body><p><span style=" "font-size:18pt;"">Wo wird ein Pointer verwendet?</span><span style=" "font-size:16pt;""><br/>Pointer werden erstellt, wo ein manuelles Speichermanagement <br>erfolgt.Zudem ist die Gr&ouml;&szlig;e von Pointern immer gleich, was <br>beim Kompilieren des Codes wichtig ist.</span></p></body></html>");
