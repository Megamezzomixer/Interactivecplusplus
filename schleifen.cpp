...
void schleifen::on_pushButton_clicked()
{
    ...
    else if(zaehler1 == 2)
    {
        ...
        ui->label_2->setText("<html><head/><body><p><span style=" "font-size:18pt;"">Wo wird eine Schleife verwendet?</span></p><p><span style=" "font-size:16pt;"">Eine Schleife wird innerhalb des Programms ausgeführt. Sie wird innerhalb </span></p><p><span style=" "font-size:16pt;"">der Klasse und der Methode verwendet. Die Schleife kann nicht außerhalb </span></p><p><span style=" "font-size:16pt;"">einer Klasse verwendet werden.</span></p><p><span style=" "font-size:16pt;""></span></p><p><span style=" "font-size:16pt; font-weight:600;"">public void fahren()</span></p><p><span style=" "font-size:16pt; font-weight:600;"">{</span></p><p><span style=" "font-size:16pt; font-weight:600;"">for(i=0;i&lt;10;i++)</span></p><p><span style=" "font-size:16pt; font-weight:600;"">{</span></p><p><span style=" "font-size:16pt; font-weight:600;"">}</span></p><p><span style=" "font-size:16pt; font-weight:600;"">}</span></p></body></html>");
