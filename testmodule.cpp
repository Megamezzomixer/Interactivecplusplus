...
if(ui->tb1->text() == "x")
{ui->tb1->setStyleSheet("background-color:green"); wert1 = true;}
else
{ui->tb1->setStyleSheet("background-color:red");wert1 = false;}

if(ui->tb2->text() == "5")
{ui ->tb2 -> setStyleSheet("background-color:green"); wert2 = true;}
else
{ui->tb2->setStyleSheet("background-color:red"); wert2 = false;}
...
{ui ->tb4 -> setStyleSheet("background-color:green"); wert4 = true;}
else
{ui->tb4->setStyleSheet("background-color:red"); wert4 = false;}
...
{ui->checkBox2->setStyleSheet("background-color:green"); wert6 = true;}
else
{ui->checkBox2->setStyleSheet("background-color:red"); wert6 = false;}
if(ui->checkBox3->isChecked() == true)
{ui->checkBox3->setStyleSheet("background-color:green"); wert7 = true;}
else
{ui->checkBox3->setStyleSheet("background-color:red"); wert7 = false;}



if(wert1 && wert2 && wert3 && wert4 && wert5 && wert6 && wert7)
{
    std::ofstream out("/home/ese/progress.txt");
