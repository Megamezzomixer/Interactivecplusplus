...
if(ui->checkBox2->isChecked() == false){ui->checkBox2->setStyleSheet("background-color:green"); wert6 = true;}else{ui->checkBox2->setStyleSheet("background-color:red"); wert6 = false;}
if(ui->checkBox3->isChecked() == true){ui->checkBox3->setStyleSheet("background-color:green"); wert7 = true;}else{ui->checkBox3->setStyleSheet("background-color:red"); wert7 = false;}
